...
public class SendEmailTestPass extends BaseTests{

    Faker faker;  String email;  String password;  String product;  String fName;  String lName;
    String friendEmail; String personalMessage;
    ...
    public void setUpData() {
        ...
        friendEmail = faker.internet().emailAddress();                     personalMessage = faker.lorem().sentence();
    }
    ...
    public void testEmailFriendPass(){
        ...
        String actualResult = emailFriendPage.getValidationMessagePass();
